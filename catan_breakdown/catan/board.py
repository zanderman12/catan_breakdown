...
# Real (x, y) plane coordinates for each node, generated from a pointy-top
# hex grid with circumradius 1.  The board is centered at the origin; y
# increases upward.  Adjacent nodes are always exactly distance 1 apart.
# Generated by hex_grid_vertices.py with row_counts=[3,4,5,4,3].
NODE_COORDS = {
    # row 0 (top, 7 nodes)
    1:  (-2.598076,  3.5), 2:  (-1.732051,  4.0), 3:  (-0.866025,  3.5),
    4:  ( 0.000000,  4.0), 5:  ( 0.866025,  3.5), 6:  ( 1.732051,  4.0),
    7:  ( 2.598076,  3.5),
    # row 1 (9 nodes)
    8:  (-3.464102,  2.0), 9:  (-2.598076,  2.5), 10: (-1.732051,  2.0),
    11: (-0.866025,  2.5), 12: ( 0.000000,  2.0), 13: ( 0.866025,  2.5),
    14: ( 1.732051,  2.0), 15: ( 2.598076,  2.5), 16: ( 3.464102,  2.0),
    # row 2 (11 nodes)
    17: (-4.330127,  0.5), 18: (-3.464102,  1.0), 19: (-2.598076,  0.5),
    20: (-1.732051,  1.0), 21: (-0.866025,  0.5), 22: ( 0.000000,  1.0),
    23: ( 0.866025,  0.5), 24: ( 1.732051,  1.0), 25: ( 2.598076,  0.5),
    26: ( 3.464102,  1.0), 27: ( 4.330127,  0.5),
    # row 3 (11 nodes)
    28: (-4.330127, -0.5), 29: (-3.464102, -1.0), 30: (-2.598076, -0.5),
    31: (-1.732051, -1.0), 32: (-0.866025, -0.5), 33: ( 0.000000, -1.0),
    34: ( 0.866025, -0.5), 35: ( 1.732051, -1.0), 36: ( 2.598076, -0.5),
    37: ( 3.464102, -1.0), 38: ( 4.330127, -0.5),
    # row 4 (9 nodes)
    39: (-3.464102, -2.0), 40: (-2.598076, -2.5), 41: (-1.732051, -2.0),
    42: (-0.866025, -2.5), 43: ( 0.000000, -2.0), 44: ( 0.866025, -2.5),
    45: ( 1.732051, -2.0), 46: ( 2.598076, -2.5), 47: ( 3.464102, -2.0),
    # row 5 (bottom, 7 nodes)
    48: (-2.598076, -3.5), 49: (-1.732051, -4.0), 50: (-0.866025, -3.5),
    51: ( 0.000000, -4.0), 52: ( 0.866025, -3.5), 53: ( 1.732051, -4.0),
    54: ( 2.598076, -3.5),
}
