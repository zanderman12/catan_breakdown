...
# hex grid centered at the origin (y increases upward).  x is scaled by 2/√3
# so each hexagon has equal width and height (both = 2 units), making them
# visually square-bounded.  x is always an integer; y is a multiple of 0.5.
# Generated by hex_grid_vertices.py with row_counts=[3,4,5,4,3].
NODE_COORDS = {
    # row 0 (top, 7 nodes)
    1:  (-3,  3.5), 2:  (-2,  4.0), 3:  (-1,  3.5),
    4:  ( 0,  4.0), 5:  ( 1,  3.5), 6:  ( 2,  4.0), 7:  ( 3,  3.5),
    # row 1 (9 nodes)
    8:  (-4,  2.0), 9:  (-3,  2.5), 10: (-2,  2.0), 11: (-1,  2.5),
    12: ( 0,  2.0), 13: ( 1,  2.5), 14: ( 2,  2.0), 15: ( 3,  2.5), 16: ( 4,  2.0),
    # row 2 (11 nodes)
    17: (-5,  0.5), 18: (-4,  1.0), 19: (-3,  0.5), 20: (-2,  1.0), 21: (-1,  0.5),
    22: ( 0,  1.0), 23: ( 1,  0.5), 24: ( 2,  1.0), 25: ( 3,  0.5), 26: ( 4,  1.0),
    27: ( 5,  0.5),
    # row 3 (11 nodes)
    28: (-5, -0.5), 29: (-4, -1.0), 30: (-3, -0.5), 31: (-2, -1.0), 32: (-1, -0.5),
    33: ( 0, -1.0), 34: ( 1, -0.5), 35: ( 2, -1.0), 36: ( 3, -0.5), 37: ( 4, -1.0),
    38: ( 5, -0.5),
    # row 4 (9 nodes)
    39: (-4, -2.0), 40: (-3, -2.5), 41: (-2, -2.0), 42: (-1, -2.5),
    43: ( 0, -2.0), 44: ( 1, -2.5), 45: ( 2, -2.0), 46: ( 3, -2.5), 47: ( 4, -2.0),
    # row 5 (bottom, 7 nodes)
    48: (-3, -3.5), 49: (-2, -4.0), 50: (-1, -3.5),
    51: ( 0, -4.0), 52: ( 1, -3.5), 53: ( 2, -4.0), 54: ( 3, -3.5),
}
